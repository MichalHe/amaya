...
(assert
 (exists ((v_nnf_94 Int) (v_nnf_95 Int))
  (and (<= c_hanoi_~n 4) (<= (+ (* 2 v_nnf_94) 1) |c_hanoi_#t~ret0|)
  (<= (+ (* 2 v_nnf_95) 1) v_nnf_94) 
  (<= 1 v_nnf_95) (<= |c_hanoi_#in~n| c_hanoi_~n))))
(assert
 (not
 (and (<= |c_hanoi_#in~n| c_hanoi_~n)
 (exists ((v_nnf_97 Int) (v_nnf_96 Int))
  (and (<= |c_hanoi_#in~n| 4) 
  (<= (+ (* 2 v_nnf_96) 1) |c_hanoi_#t~ret0|)
  (<= (+ (* 2 v_nnf_97) 1) v_nnf_96) 
  (<= 1 v_nnf_97))))))
(check-sat)
(exit)
