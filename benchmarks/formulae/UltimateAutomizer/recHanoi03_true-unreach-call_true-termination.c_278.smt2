...
(assert
 (exists ((v_nnf_14 Int) (v_nnf_13 Int))
  (and (<= c_hanoi_~n 4) (<= (+ (* 2 v_nnf_14) 1) |c_hanoi_#t~ret0|)
  (<= 1 v_nnf_13) (<= (+ (* 2 v_nnf_13) 1) v_nnf_14)
  (<= |c_hanoi_#in~n| c_hanoi_~n))))
(assert
 (not
 (and (<= |c_hanoi_#in~n| c_hanoi_~n)
 (exists ((v_nnf_16 Int) (v_nnf_15 Int))
  (and (<= |c_hanoi_#in~n| 4) 
  (<= (+ (* 2 v_nnf_16) 1) v_nnf_15) 
  (<= 1 v_nnf_16) (<= (+ (* 2 v_nnf_15) 1) |c_hanoi_#t~ret0|))))))
(check-sat)
(exit)
