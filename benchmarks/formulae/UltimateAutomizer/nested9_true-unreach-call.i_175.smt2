...
(assert
 (and (<= c_main_~i~6 2)
 (exists ((v_nnf_10 Int))
  (and (<= (+ v_nnf_10 1) c_main_~k~6) 
  (<= c_main_~j~6 (+ (* 2 v_nnf_10) 1)) 
  (<= v_nnf_10 2))) (<= c_main_~j~6 (+ (* 2 c_main_~i~6) 1))
 (<= c_main_~i~6 1) (<= c_main_~j~6 (* 2 c_main_~i~6))))
(assert
 (not
 (and (<= c_main_~i~6 2) (<= c_main_~j~6 (+ (* 2 c_main_~i~6) 1))
 (exists ((main_~i~6 Int))
  (and (<= c_main_~j~6 (+ (* 2 main_~i~6) 1)) 
  (<= main_~i~6 2) (<= main_~i~6 c_main_~k~6))))))
(check-sat)
(exit)
