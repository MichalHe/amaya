...
(assert
 (exists ((v_nnf_35 Int) (v_nnf_36 Int) (v_nnf_34 Int))
  (and (<= (+ (* 2 v_nnf_34) 1) |c_hanoi_#t~ret0|) 
  (<= c_hanoi_~n 5) (<= 1 v_nnf_35) 
  (<= (+ (* 2 v_nnf_35) 1) v_nnf_36) 
  (<= (+ (* 2 v_nnf_36) 1) v_nnf_34) 
  (<= |c_hanoi_#in~n| c_hanoi_~n))))
(assert
 (not
 (and (<= |c_hanoi_#in~n| c_hanoi_~n)
 (exists ((v_nnf_39 Int) (v_nnf_37 Int) (v_nnf_38 Int))
  (and (<= |c_hanoi_#in~n| 5) 
  (<= (+ (* 2 v_nnf_38) 1) v_nnf_39)
  (<= (+ (* 2 v_nnf_39) 1) |c_hanoi_#t~ret0|)
  (<= (+ (* 2 v_nnf_37) 1) v_nnf_38) 
  (<= 1 v_nnf_37))))))
(check-sat)
(exit)
