...
(assert
 (and (<= c_main_~i~6 2)
 (exists ((v_nnf_46 Int))
  (and (<= (+ v_nnf_46 2) c_main_~k~6) 
  (<= v_nnf_46 3) (<= c_main_~j~6 (+ (* 2 v_nnf_46) 2))))
 (<= c_main_~j~6 (* 2 c_main_~i~6)) 
 (<= c_main_~i~6 3) (<= c_main_~j~6 (+ (* 2 c_main_~i~6) 2))
 (<= c_main_~j~6 (+ (* 2 c_main_~i~6) 1))))
(assert
 (not
 (and (<= c_main_~i~6 2)
 (exists ((v_nnf_44 Int))
  (and (<= (+ v_nnf_44 1) c_main_~k~6) 
  (<= c_main_~j~6 (+ (* 2 v_nnf_44) 2)) 
  (<= v_nnf_44 3))) (<= c_main_~i~6 3)
 (<= c_main_~j~6 (+ (* 2 c_main_~i~6) 2))
 (<= c_main_~j~6 (+ (* 2 c_main_~i~6) 1)))))
(check-sat)
(exit)
