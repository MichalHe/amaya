...
(assert
 (exists ((v_nnf_229 Int) (v_nnf_228 Int))
  (and (<= c_hanoi_~n 4) (<= (+ (* 2 v_nnf_229) 1) |c_hanoi_#t~ret0|)
  (<= |c_hanoi_#in~n| c_hanoi_~n) 
  (<= 1 v_nnf_228) (<= (+ (* 2 v_nnf_228) 1) v_nnf_229))))
(assert
 (not
 (exists ((v_nnf_231 Int) (v_nnf_230 Int))
  (and (<= |c_hanoi_#in~n| 4) 
  (<= (+ (* 2 v_nnf_231) 1) v_nnf_230)
  (<= (+ (* 2 v_nnf_230) 1) |c_hanoi_#t~ret0|) 
  (<= 1 v_nnf_231)))))
(check-sat)
(exit)
