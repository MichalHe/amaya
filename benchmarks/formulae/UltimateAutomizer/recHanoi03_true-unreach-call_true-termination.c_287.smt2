...
(assert
 ...
 (exists ((|v_hanoi_#t~ret0_10| Int) (v_nnf_18 Int) (v_nnf_17 Int))
  (and (<= (+ (* 2 |v_hanoi_#t~ret0_10|) 1) |c_hanoi_#res|)
  (<= |c_hanoi_#in~n| 4) (<= 1 v_nnf_17) 
  (<= (+ (* 2 v_nnf_17) 1) v_nnf_18)
  (<= (+ (* 2 v_nnf_18) 1) |v_hanoi_#t~ret0_10|)))))
(assert
 (not
 (exists ((|v_hanoi_#t~ret0_10| Int) (v_nnf_18 Int) (v_nnf_17 Int))
  (and (<= (+ (* 2 |v_hanoi_#t~ret0_10|) 1) |c_hanoi_#res|)
