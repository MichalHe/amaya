...
(assert
 (and (<= 1 c_main_~i~6)
 (exists ((v_nnf_72 Int))
  (and (<= c_main_~k~6 (+ v_nnf_72 2)) 
  (<= 4 v_nnf_72) (<= (* 2 v_nnf_72) c_main_~j~6))) 
 (<= 0 c_main_~i~6) (<= 3 c_main_~i~6) 
 (<= 2 c_main_~i~6)))
(assert
 (not
 (and (<= 1 c_main_~i~6) (<= 0 c_main_~i~6)
 (exists ((v_nnf_74 Int))
  (and (<= c_main_~k~6 (+ v_nnf_74 3)) 
  (<= (* 2 v_nnf_74) c_main_~j~6) 
  (<= 4 v_nnf_74))) (<= 3 c_main_~i~6) 
 (<= 2 c_main_~i~6))))
(check-sat)
(exit)
