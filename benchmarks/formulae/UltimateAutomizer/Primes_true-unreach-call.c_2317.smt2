...
(assert
 (exists ((v_nnf_111 Int) (v_nnf_112 Int))
  (and (<= (+ c_mult_~n (* 2 v_nnf_111) (* 2 v_nnf_112) 1) |c_mult_#res|)
  (<= c_mult_~n v_nnf_111) 
  (<= v_nnf_111 v_nnf_112) 
...
(assert
 ...
 (exists ((v_nnf_114 Int) (v_nnf_113 Int))
  (and (<= |c_mult_#in~n| v_nnf_113)
  (<= (+ (* 2 v_nnf_114) (* 2 v_nnf_113) |c_mult_#in~n| 1) |c_mult_#res|)
  (<= v_nnf_113 v_nnf_114))))))
(check-sat)
(exit)
