...
(assert
 ...
 (exists ((v_nnf_60 Int) (v_nnf_58 Int) (v_nnf_59 Int))
  (and
  (<= (+ (* 2 v_nnf_60) (* 2 v_nnf_58) (* 2 v_nnf_59) 1) |c_main_#t~ret12|)
  (<= c_main_~f1~22 v_nnf_58) 
  (<= v_nnf_58 v_nnf_60) (<= v_nnf_60 v_nnf_59) 
  (<= c_main_~n~22 2)))))
(assert
 (not
 (exists ((v_nnf_60 Int) (v_nnf_58 Int) (v_nnf_59 Int))
