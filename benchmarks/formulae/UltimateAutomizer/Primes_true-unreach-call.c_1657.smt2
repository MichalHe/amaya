...
(assert
 (exists ((v_nnf_94 Int) (v_nnf_95 Int) (v_nnf_96 Int))
  (and
  (<= (+ c_main_~f1~22 (* 2 v_nnf_94) (* 2 v_nnf_95) (* 2 v_nnf_96) 1)
  |c_main_#t~ret12|) (<= c_main_~f1~22 v_nnf_94) 
  (<= v_nnf_96 v_nnf_95) (<= v_nnf_94 v_nnf_96) 
  (<= c_main_~n~22 2))))
(assert
 (not
 (and
