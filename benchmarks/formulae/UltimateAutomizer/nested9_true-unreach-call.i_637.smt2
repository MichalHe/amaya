...
(assert
 (and (<= c_main_~j~6 (* 2 c_main_~i~6)) 
 (<= c_main_~i~6 3) (<= c_main_~j~6 (+ (* 2 c_main_~i~6) 1))
 (exists ((v_nnf_34 Int))
  (and (<= (+ v_nnf_34 3) c_main_~k~6) 
  (<= v_nnf_34 3) (<= c_main_~j~6 (+ (* 2 v_nnf_34) 1))))))
(assert
 (not
 (and (<= c_main_~j~6 (* 2 c_main_~i~6)) 
 (<= c_main_~i~6 3) (<= c_main_~j~6 (+ (* 2 c_main_~i~6) 1))
 (exists ((v_nnf_30 Int))
  (and (<= (+ v_nnf_30 1) c_main_~k~6) 
  (<= v_nnf_30 3) (<= c_main_~j~6 (+ (* 2 v_nnf_30) 1)))))))
(check-sat)
(exit)
