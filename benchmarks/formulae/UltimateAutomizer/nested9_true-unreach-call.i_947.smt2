...
(assert
 (and (<= 3 c_main_~i~6) (<= (+ (* 2 c_main_~i~6) 1) c_main_~j~6)
 (<= 2 c_main_~i~6) (<= (* 2 c_main_~i~6) c_main_~j~6)
 (exists ((v_nnf_54 Int))
  (and (<= c_main_~k~6 (+ v_nnf_54 1)) 
  (<= 3 v_nnf_54) (<= (+ (* 2 v_nnf_54) 2) c_main_~j~6))) 
 (<= 0 c_main_~i~6) (<= 1 c_main_~i~6)))
(assert
 (not
 (and (<= 3 c_main_~i~6)
 (exists ((v_nnf_58 Int))
  (and (<= c_main_~k~6 (+ v_nnf_58 3)) 
  (<= 3 v_nnf_58) (<= (+ (* 2 v_nnf_58) 2) c_main_~j~6)))
 (<= (+ (* 2 c_main_~i~6) 1) c_main_~j~6) 
 (<= 2 c_main_~i~6) (<= (* 2 c_main_~i~6) c_main_~j~6) 
 (<= 0 c_main_~i~6) (<= 1 c_main_~i~6))))
(check-sat)
(exit)
