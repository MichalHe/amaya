...
(assert
 (exists ((v_nnf_151 Int) (v_nnf_152 Int))
  (and (<= c_hanoi_~n 4) (<= (+ (* 2 v_nnf_151) 1) |c_hanoi_#t~ret0|)
  (<= 1 v_nnf_152) (<= (+ (* 2 v_nnf_152) 1) v_nnf_151)
  (<= |c_hanoi_#in~n| c_hanoi_~n))))
(assert
 (not
 (exists ((v_nnf_154 Int) (v_nnf_153 Int))
  (and (<= |c_hanoi_#in~n| 4) 
  (<= 1 v_nnf_154) (<= (+ (* 2 v_nnf_153) 1) |c_hanoi_#t~ret0|)
  (<= (+ (* 2 v_nnf_154) 1) v_nnf_153)))))
(check-sat)
(exit)
