...
(assert
 (exists ((v_nnf_236 Int) (v_nnf_235 Int) (v_nnf_234 Int))
  (and (<= c_hanoi_~n 5) (<= (+ (* 2 v_nnf_235) 1) |c_hanoi_#t~ret0|)
  (<= 1 v_nnf_236) (<= (+ (* 2 v_nnf_236) 1) v_nnf_234)
  (<= (+ (* 2 v_nnf_234) 1) v_nnf_235) 
  (<= |c_hanoi_#in~n| c_hanoi_~n))))
(assert
 (not
 (exists ((v_nnf_239 Int) (v_nnf_238 Int) (v_nnf_237 Int))
  (and (<= |c_hanoi_#in~n| 5) 
  (<= (+ (* 2 v_nnf_239) 1) v_nnf_238) 
  (<= 1 v_nnf_237) (<= (+ (* 2 v_nnf_237) 1) v_nnf_239)
  (<= (+ (* 2 v_nnf_238) 1) |c_hanoi_#t~ret0|)))))
(check-sat)
(exit)
