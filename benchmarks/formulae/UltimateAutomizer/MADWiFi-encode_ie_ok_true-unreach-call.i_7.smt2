...
(assert
 (and (< c_main_~i~6 c_main_~ielen~6) 
 (<= 3 c_main_~i~6)
 (<= (+ (* 2 c_main_~ielen~6) c_main_~p~6) (+ c_main_~bufsize_0~6 6))))
(assert
 (not
 (and (<= (+ (* 2 c_main_~ielen~6) c_main_~p~6) (+ c_main_~bufsize_0~6 6))
 (<= 2 c_main_~i~6)
 (exists ((main_~ielen~6 Int))
  (and (<= 4 main_~ielen~6)
  (<= (+ (* 2 main_~ielen~6) c_main_~p~6) (+ c_main_~bufsize_0~6 6))))
 (<= 3 c_main_~i~6))))
(check-sat)
(exit)
