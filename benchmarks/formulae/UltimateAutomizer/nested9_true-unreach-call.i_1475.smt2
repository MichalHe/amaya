...
(assert
 ...
 (<= 4 c_main_~i~6) (<= (* 2 c_main_~i~6) c_main_~j~6) 
 (<= 2 c_main_~i~6) (<= 0 c_main_~i~6) 
 (<= 1 c_main_~i~6)
 (exists ((main_~i~6 Int))
  (and (<= c_main_~k~6 main_~i~6) 
  (<= 4 main_~i~6) (<= (+ (* 2 main_~i~6) 1) c_main_~j~6)))))
(assert
 (not
 (and (<= 3 c_main_~i~6) (<= (+ (* 2 c_main_~i~6) 1) c_main_~j~6)
 (<= 4 c_main_~i~6) (<= (* 2 c_main_~i~6) c_main_~j~6) 
 ...
 (<= 1 c_main_~i~6)
 (exists ((v_nnf_88 Int))
  (and (<= c_main_~k~6 (+ v_nnf_88 2)) 
  (<= 4 v_nnf_88) (<= (+ (* 2 v_nnf_88) 1) c_main_~j~6))))))
(check-sat)
(exit)
