...
(assert
 ...
 (exists ((main_~i~6 Int))
  (and (<= c_main_~k~6 main_~i~6) 
  (<= 3 main_~i~6) (<= (* 2 main_~i~6) c_main_~j~6))) 
 (<= 1 c_main_~i~6) (<= 3 c_main_~i~6) 
 (<= 2 c_main_~i~6) (<= (* 2 c_main_~i~6) c_main_~j~6)))
(assert
 (not
 (and (<= 0 c_main_~i~6)
 (exists ((v_nnf_28 Int))
  (and (<= c_main_~k~6 (+ v_nnf_28 2)) 
  (<= (* 2 v_nnf_28) c_main_~j~6) 
  (<= 3 v_nnf_28))) (<= 1 c_main_~i~6) 
 (<= 3 c_main_~i~6) (<= 2 c_main_~i~6) 
 (<= (* 2 c_main_~i~6) c_main_~j~6))))
(check-sat)
(exit)
