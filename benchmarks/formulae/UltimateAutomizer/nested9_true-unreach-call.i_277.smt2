...
(assert
 (and (<= c_main_~i~6 3) (<= c_main_~i~6 1)
 (exists ((v_nnf_20 Int))
  (and (<= (+ v_nnf_20 1) c_main_~k~6) 
  (<= c_main_~j~6 (* 2 v_nnf_20)) 
  (<= v_nnf_20 3))) (<= c_main_~j~6 (* 2 c_main_~i~6)) 
 (<= c_main_~i~6 2)))
(assert
 (not
 (and (<= c_main_~i~6 3)
 (exists ((main_~i~6 Int))
  (and (<= main_~i~6 3) (<= c_main_~j~6 (* 2 main_~i~6))
  (<= main_~i~6 c_main_~k~6))) 
