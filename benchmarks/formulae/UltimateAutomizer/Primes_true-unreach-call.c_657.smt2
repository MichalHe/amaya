...
(assert
 (exists ((v_nnf_31 Int) (v_nnf_30 Int))
  (and (<= (+ c_mult_~n (* 2 v_nnf_31) (* 2 v_nnf_30) 1) |c_mult_#res|)
  (<= c_mult_~n v_nnf_30) 
  (<= v_nnf_30 v_nnf_31) (<= |c_mult_#in~n| c_mult_~n))))
(assert
 (not
 (and (<= |c_mult_#in~n| c_mult_~n)
 (exists ((v_nnf_32 Int) (v_nnf_33 Int))
  (and (<= |c_mult_#in~n| v_nnf_33)
  (<= (+ (* 2 v_nnf_32) (* 2 v_nnf_33) |c_mult_#in~n| 1) |c_mult_#res|)
  (<= v_nnf_33 v_nnf_32))))))
(check-sat)
(exit)
