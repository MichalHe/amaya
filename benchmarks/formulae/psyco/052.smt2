...
(assert
 ...
 (($x6609
   ...
   (and $x223 $x2267 (not W_S2_V3) DISJ_W_S2_R_S1)
   (and $x223 (not W_S1_V5) (not W_S2_V3) DISJ_W_S2_R_S1)
   (and (not R_S2_V5) $x223 (not W_S2_V3) DISJ_W_S2_R_S1)
   (and (not R_S2_V5) (not W_S1_V4) (not W_S2_V3) DISJ_W_S2_R_S1)
   (and $x215 $x217 $x223 $x2259 DISJ_W_S2_R_S1)
   (and $x215 $x223 $x2259 (not W_S2_V3) DISJ_W_S2_R_S1)
...
(assert
 ...
 (let (($x202 (not R_S1_V1)))
 (let
 (($x6943 (and $x202 $x217 $x2216 $x2267 DISJ_W_S2_R_S1 DISJ_W_S1_R_S1)))
 (not $x6943)))))))
(check-sat)
(exit)
