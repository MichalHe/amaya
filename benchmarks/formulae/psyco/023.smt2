...
(assert
 ...
 (($x3307
   (forall
    ...
    (let
    (($x2869
      (= (ite MW_S2_V2 S2_V2_!1523 (ite MW_S1_V2 S1_V2_!1518 V2_0))
      (ite MW_S2_V2 S2_V2_!1540 (ite MW_S1_V2 S1_V2_!1534 V2_0)))))
    (let
    (($x2630
    ...
    (($x3391
      ...
      (ite MW_S2_V1 S2_V1_!1538 E1_!1537)) $x2630 $x2869 $x2640 $x2832)))
    (let
    (($x2634
      (>= (ite MW_S2_V1 S2_V1_!1538 E1_!1537)
      (+ (- 1) (ite MW_S2_V2 S2_V2_!1540 (ite MW_S1_V2 S1_V2_!1534 V2_0))))))
    (let
    (($x2754
      (>=
      (ite MW_S1_V1 S1_V1_!1532 (+ 1 (ite MW_S1_V1 S1_V1_!1527 E1_!1526)))
      (+ (- 1) (ite MW_S1_V2 S1_V2_!1534 V2_0)))))
    (let
    (($x2760
      (>= (ite MW_S2_V1 S2_V1_!1521 (ite MW_S1_V1 S1_V1_!1516 E1_!1515))
      (+ (- 1) (ite MW_S2_V2 S2_V2_!1523 (ite MW_S1_V2 S1_V2_!1518 V2_0))))))
    (let
    (($x2873
      (and (not (<= V2_0 E1_!1515)) $x2760 
      (not (<= V2_0 E1_!1526))
      (not
      (<= (ite MW_S1_V2 S1_V2_!1529 V2_0)
      (+ 1 (ite MW_S1_V1 S1_V1_!1527 E1_!1526)))) $x2754
      (not (<= (ite MW_S1_V2 S1_V2_!1534 V2_0) E1_!1537)) $x2634)))
    (let
    (($x3153
      (and
      ...
      (or (not R_S2_V2)
      (= (ite MW_S1_V2 S1_V2_!1534 V2_0) (ite MW_S1_V2 S1_V2_!1518 V2_0)))
      (or (not R_S2_V5)
    ...
    (($x2877
      (and
      (or (not R_S1_V1)
      (= (ite MW_S1_V1 S1_V1_!1527 E1_!1526) (+ (- 1) E1_!1526)))
      (or (not R_S1_V3) (= (ite MW_S1_V3 S1_V3_!1528 V3_0) V3_0))
      (or (not R_S1_V2) (= (ite MW_S1_V2 S1_V2_!1529 V2_0) V2_0))
      (or (not R_S1_V5) (= (ite MW_S1_V5 S1_V5_!1530 V5_0) V5_0))
      (or (not R_S1_V4) (= (ite MW_S1_V4 S1_V4_!1531 V4_0) V4_0)))))
    (let (($x2843 (not $x2877)))
    (let
    (($x2918
      (and
      (or (not R_S1_V1)
      (= (ite MW_S1_V1 S1_V1_!1527 E1_!1526) (+ (- 1) E1_!1515)))
      (or (not R_S1_V3) (= (ite MW_S1_V3 S1_V3_!1528 V3_0) V3_0))
      (or (not R_S1_V2) (= (ite MW_S1_V2 S1_V2_!1529 V2_0) V2_0))
      (or (not R_S1_V5) (= (ite MW_S1_V5 S1_V5_!1530 V5_0) V5_0))
      (or (not R_S1_V4) (= (ite MW_S1_V4 S1_V4_!1531 V4_0) V4_0)))))
    ...
    (($x2612
      (and
      (or (not R_S1_V1)
      (= E1_!1526 (+ 1 (ite MW_S1_V1 S1_V1_!1527 E1_!1526))))
      (or (not R_S1_V3) (= V3_0 (ite MW_S1_V3 S1_V3_!1528 V3_0)))
      (or (not R_S1_V2) (= V2_0 (ite MW_S1_V2 S1_V2_!1529 V2_0)))
      (or (not R_S1_V5) (= V5_0 (ite MW_S1_V5 S1_V5_!1530 V5_0)))
      (or (not R_S1_V4) (= V4_0 (ite MW_S1_V4 S1_V4_!1531 V4_0))))))
    (let
    (($x2635
      (and
      (or (not R_S1_V1)
      (= E1_!1515 (+ 1 (ite MW_S1_V1 S1_V1_!1527 E1_!1526))))
      (or (not R_S1_V3) (= V3_0 (ite MW_S1_V3 S1_V3_!1528 V3_0)))
      (or (not R_S1_V2) (= V2_0 (ite MW_S1_V2 S1_V2_!1529 V2_0)))
      (or (not R_S1_V5) (= V5_0 (ite MW_S1_V5 S1_V5_!1530 V5_0)))
      (or (not R_S1_V4) (= V4_0 (ite MW_S1_V4 S1_V4_!1531 V4_0))))))
