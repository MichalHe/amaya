 ...
 (($x3307
   (forall
    ...
    (($x2873
      ...
      (>= ?x2642 (+ (- 1) ?x2876)))))
    (let (($x2461 (or (not MW_S2_V5) W_S2_V5)))
    (let (($x2890 (or (not MW_S2_V2) W_S2_V2)))
    (let (($x2921 (or (not MW_S2_V3) W_S2_V3)))
    (let (($x2923 (or (not MW_S2_V1) W_S2_V1)))
    (let (($x2468 (or (not MW_S1_V4) W_S1_V4)))
    (let (($x2431 (or (not MW_S1_V5) W_S1_V5)))
    ...
    (let (($x2632 (or $x215 (= E1_!1537 ?x2604))))
    (let (($x3103 (not (and $x2632 $x2762 $x2975 $x3148 $x3036))))
    ...
    (($x2918
      ...
      $x2820 $x2821 $x2565)))
    (let (($x2203 (not $x2918)))
    (let (($x2506 (not (or (not R_S1_V1) (= E1_!1526 E1_!1515)))))
    (let (($x2475 (or $x2506 (= S1_V4_!1531 S1_V4_!1520))))
    ...
    (($x2612
      ...
      $x2709 $x2882)))
    (let (($x2631 (or $x2506 (= S1_V5_!1530 S1_V5_!1519))))
    ...
    (let (($x2512 (or $x158 (= (ite MW_S1_V4 S1_V4_!1536 V4_0) V4_0))))
    (let (($x156 (not R_E1_V5)))
    (let (($x3037 (or $x156 (= (ite MW_S1_V5 S1_V5_!1535 V5_0) V5_0))))
    (let (($x154 (not R_E1_V2)))
    (let (($x3480 (or $x154 (= ?x2740 V2_0))))
    (let (($x2885 (= E1_!1515 E1_!1537)))
    (let (($x2857 (or $x158 (= V4_0 (ite MW_S1_V4 S1_V4_!1536 V4_0)))))
    (let (($x3375 (or $x156 (= V5_0 (ite MW_S1_V5 S1_V5_!1535 V5_0)))))
    (let (($x3097 (or $x154 (= V2_0 ?x2740))))
    (let (($x2692 (= E1_!1515 E1_!1526)))
    (let (($x2847 (not (or (not R_S1_V1) $x2692))))
    (let (($x2860 (or $x2847 (= S1_V2_!1518 S1_V2_!1529))))
    (let (($x2696 (or $x2847 (= S1_V3_!1517 S1_V3_!1528))))
    (let (($x2592 (or $x2847 (= S1_V1_!1516 S1_V1_!1527))))
    (let
    (($x2669
      (and $x2592 (or (not $x2635) (= S1_V1_!1516 S1_V1_!1532))
      (or $x2843 (= S1_V1_!1532 S1_V1_!1527))
      (or $x3103 (= S2_V5_!1541 S2_V5_!1524)) $x2696
      (or $x2203 (= S1_V3_!1533 S1_V3_!1517))
      (or $x2843 (= S1_V3_!1533 S1_V3_!1528)) $x2860
      (or $x2203 (= S1_V2_!1534 S1_V2_!1518))
      (or $x2843 (= S1_V2_!1534 S1_V2_!1529)) $x2692
      (or (not (and $x3097 $x3375 $x2857)) $x2885)
      (or (not (and $x3480 $x3037 $x2512)) $x2747)
      (or $x3103 (= S2_V4_!1542 S2_V4_!1525)) 
      (or (not $x2635) $x2703) $x2631 
      (or (not $x2612) $x2204) 
      (or $x3103 (= S2_V1_!1538 S2_V1_!1521)) $x2475 
      (or $x2203 $x2484) (or $x2843 $x2706)
      (or $x3103 (= S2_V2_!1540 S2_V2_!1523)) 
      (or $x3103 $x2439) (not MW_S1_V1) 
      (not MW_S1_V2) $x2431 $x2468 $x2923 $x2921 $x2890 $x2461)))
    (or (not $x2669) (not $x2873) (and $x3369 $x2630 $x2869 $x2640 $x2832))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 (let
...
(assert
 ...
 (let (($x4092 (and $x202 DISJ_W_S1_R_S1))) (not $x4092))))
(check-sat)
(exit)
