...
(assert
 ...
 (($x2544
   (forall
    ...
    (let (($x2523 (= E1_!337 V1_0)))
    (let (($x150 (not R_E1_V1)))
    (let (($x2524 (or $x150 $x2523)))
    (let (($x2525 (not $x2524)))
    (let (($x2527 (or $x2525 $x2495)))
    (let (($x2500 (= E1_!338 E1_!336)))
    (let (($x2526 (or $x2525 $x2500)))
    (let (($x2502 (= E1_!337 E1_!336)))
    (let
    (($x2536
      (and $x2502 $x2526 $x2527 $x2528 $x2529 $x2530 $x2531 $x2532 $x2533
      $x2534 $x2535)))
