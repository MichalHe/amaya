...
(assert
 ...
 (let (($x223 (not R_S2_V4)))
 (let (($x215 (not R_S2_V1)))
 (not (and $x215 $x223 $x2259 $x2285 DISJ_W_S2_R_S1)))))))
(assert
 (let (($x2259 (not W_S2_V2)))
 (let (($x223 (not R_S2_V4)))
 (let (($x221 (not R_S2_V5)))
 (let (($x215 (not R_S2_V1)))
 (not (and $x215 $x221 $x223 $x2259 DISJ_W_S2_R_S1)))))))
(assert
 (let (($x2267 (not W_S2_V5)))
 (let (($x2259 (not W_S2_V2)))
 (let (($x223 (not R_S2_V4)))
 (let (($x215 (not R_S2_V1)))
 (not (and $x215 $x223 $x2259 $x2267 DISJ_W_S2_R_S1)))))))
(assert
 (let (($x2259 (not W_S2_V2)))
 (let (($x221 (not R_S2_V5)))
 (let (($x217 (not R_S2_V3)))
 (let (($x215 (not R_S2_V1)))
 (not (and $x215 $x217 $x221 $x2259 DISJ_W_S2_R_S1)))))))
(assert
 (let (($x2285 (not W_S2_V3)))
 (let (($x2267 (not W_S2_V5)))
 (let (($x2259 (not W_S2_V2)))
 (let (($x215 (not R_S2_V1)))
 (not (and $x215 $x2259 $x2267 $x2285 DISJ_W_S2_R_S1)))))))
(assert
 (let (($x2285 (not W_S2_V3)))
 (let (($x2259 (not W_S2_V2)))
 (let (($x221 (not R_S2_V5)))
 (let (($x215 (not R_S2_V1)))
 (not (and $x215 $x221 $x2259 $x2285 DISJ_W_S2_R_S1)))))))
(assert
 (let (($x2267 (not W_S2_V5)))
 (let (($x2259 (not W_S2_V2)))
 (let (($x217 (not R_S2_V3)))
 (let (($x215 (not R_S2_V1)))
 (let (($x6563 (and $x215 $x217 $x2259 $x2267 DISJ_W_S2_R_S1))) (not $x6563)))))))
(check-sat)
(exit)
