...
(assert
 ...
 (($x1310
   (forall
    ...
    (let
    (($x1308
      (and (= ?x1227 (ite MW_S2_V6 S2_V6_!68 (ite MW_S1_V6 S1_V6_!61 V6_0)))
      (= ?x1230 (ite MW_S2_V4 S2_V4_!69 (ite MW_S1_V4 S1_V4_!62 V4_0)))
      (= ?x1233 (ite MW_S2_V5 S2_V5_!70 (ite MW_S1_V5 S1_V5_!63 V5_0)))
      (= E1_!59 (ite MW_S2_V1 S2_V1_!73 E1_!67))
      (= ?x1239 (ite MW_S2_V3 S2_V3_!72 (ite MW_S1_V3 S1_V3_!65 V3_0)))
      (= (ite MW_S2_V1 S2_V1_!58 E1_!52) (ite MW_S2_V1 S2_V1_!73 E1_!67)))))
    (let
    (($x1224
      (and (or (not R_S2_V6) (= ?x1204 (ite MW_S1_V6 S1_V6_!61 V6_0)))
      (or (not R_S2_V4) (= ?x1208 (ite MW_S1_V4 S1_V4_!62 V4_0)))
      (or (not R_S2_V5) (= ?x1212 (ite MW_S1_V5 S1_V5_!63 V5_0)))
      (or (not R_S2_V2)
      (= (ite MW_S1_V2 S1_V2_!49 V2_0) (ite MW_S1_V2 S1_V2_!64 V2_0)))
      (or (not R_S2_V3) (= ?x1220 (ite MW_S1_V3 S1_V3_!65 V3_0)))
      (or (not R_S2_V1) (= E1_!52 E1_!67)))))
    (let (($x1225 (not $x1224)))
    (let
    (($x1284
      (and (or (not R_S2_V6) (= (ite MW_S1_V6 S1_V6_!61 V6_0) ?x1204))
      (or (not R_S2_V4) (= (ite MW_S1_V4 S1_V4_!62 V4_0) ?x1208))
      (or (not R_S2_V5) (= (ite MW_S1_V5 S1_V5_!63 V5_0) ?x1212))
      (or (not R_S2_V2)
      (= (ite MW_S1_V2 S1_V2_!64 V2_0) (ite MW_S1_V2 S1_V2_!49 V2_0)))
      (or (not R_S2_V3) (= (ite MW_S1_V3 S1_V3_!65 V3_0) ?x1220))
      (or (not R_S2_V1) (= E1_!67 E1_!52)))))
    (let (($x1285 (not $x1284)))
    (let
    (($x1276
      (and (or (not R_E1_V6) (= (ite MW_S1_V6 S1_V6_!61 V6_0) ?x1204))
      (or (not R_E1_V4) (= (ite MW_S1_V4 S1_V4_!62 V4_0) ?x1208))
      (or (not R_E1_V5) (= (ite MW_S1_V5 S1_V5_!63 V5_0) ?x1212))
      (or (not R_E1_V2)
      (= (ite MW_S1_V2 S1_V2_!64 V2_0) (ite MW_S1_V2 S1_V2_!49 V2_0)))
      (or (not R_E1_V3) (= (ite MW_S1_V3 S1_V3_!65 V3_0) ?x1220))
      (or (not R_E1_V1)
    ...
    (let
    (($x1261
      (and (or (not R_E1_V6) (= ?x1227 (ite MW_S1_V6 S1_V6_!61 V6_0)))
      (or (not R_E1_V4) (= ?x1230 (ite MW_S1_V4 S1_V4_!62 V4_0)))
      (or (not R_E1_V5) (= ?x1233 (ite MW_S1_V5 S1_V5_!63 V5_0))) $x1255
      (or (not R_E1_V3) (= ?x1239 (ite MW_S1_V3 S1_V3_!65 V3_0)))
      (or (not R_E1_V1)
    ...
    (let
    (($x1245
      (and (or (not R_E1_V6) (= ?x1227 ?x1204))
      (or (not R_E1_V4) (= ?x1230 ?x1208))
      (or (not R_E1_V5) (= ?x1233 ?x1212)) $x1238
      (or (not R_E1_V3) (= ?x1239 ?x1220))
      (or (not R_E1_V1)
      (= (ite MW_S2_V1 S2_V1_!58 E1_!52) (ite MW_S1_V1 S1_V1_!51 V1_0))))))
    (let
    (($x1298
      (and (= S1_V4_!47 S1_V4_!62) 
      (or $x1225 (= S2_V4_!54 S2_V4_!69)) 
      (= S1_V6_!61 S1_V6_!46) 
      (or (not $x1245) (= E1_!59 E1_!52)) 
      (or (not $x1261) (= E1_!59 E1_!67)) 
      (or (not $x1276) (= E1_!67 E1_!52)) 
      (= S1_V1_!66 S1_V1_!51) 
      (or $x1285 (= S2_V6_!68 S2_V6_!53)) 
      (= S1_V3_!65 S1_V3_!50) 
      (= S1_V2_!64 S1_V2_!49) 
      (= B1_!60 B1_!45) (or $x1285 (= S2_V1_!73 S2_V1_!58))
      (or $x1285 (= S2_V5_!70 S2_V5_!55)) 
      (or $x1225 (= S2_V2_!56 S2_V2_!71)) 
      (or $x1225 (= S2_V3_!57 S2_V3_!72)) 
      (= S1_V5_!63 S1_V5_!48) 
    ...
    (or (not $x1298) (not (and B1_!45 B1_!60)) $x1308))))))))))))))))))))))))
 (let
 (($x289
