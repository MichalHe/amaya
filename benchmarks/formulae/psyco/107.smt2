...
(assert
 ...
 (($x59848
   (forall
    ...
    (let ((?x62301 (+ (- 1) ?x61425)))
    (let (($x61124 (>= ?x62280 ?x62301)))
    (let ((?x61096 (+ (- 1) ?x60966)))
    (let (($x60960 (>= ?x60065 ?x61096)))
    (let (($x62453 (<= V2_0 E1_!4999)))
    (let (($x61140 (not $x62453)))
    (let (($x60239 (<= V4_0 E2_!4998)))
    (let (($x61367 (not $x60239)))
    (let (($x59857 (<= V2_0 E1_!4997)))
    (let (($x62570 (not $x59857)))
    (let ((?x62418 (+ (- 1) V2_0)))
    (let (($x60189 (>= E1_!4994 ?x62418)))
    (let (($x62421 (>= E2_!4996 V4_0)))
    (let (($x60898 (<= V2_0 E1_!4994)))
    (let (($x59938 (not $x60898)))
    (let (($x62400 (<= V4_0 E2_!4995)))
