...
(assert
 ...
 (($x64904
   (forall
    ...
    (let
    (($x63753
      (= (ite MW_S1_V3 S1_V3_!7485 (+ 1 (ite MW_S1_V3 S1_V3_!7479 E2_!7477)))
      (ite MW_S1_V3 S1_V3_!7507 (+ 1 (ite MW_S1_V3 S1_V3_!7500 E2_!7491))))))
    (let
    (($x64833
      (and
      (= (ite MW_S1_V1 S1_V1_!7484 E1_!7475)
      (ite MW_S1_V1 S1_V1_!7506 E1_!7505)) $x63753
    ...
    (($x61229
      (>=
      (ite MW_S1_V3 S1_V3_!7507 (+ 1 (ite MW_S1_V3 S1_V3_!7500 E2_!7491)))
      (+ (- 1) (ite MW_S1_V4 S1_V4_!7510 V4_0)))))
    (let
    (($x60215
      (>=
    ...
    (($x62425
      (>=
      (ite MW_S1_V3 S1_V3_!7485 (+ 1 (ite MW_S1_V3 S1_V3_!7479 E2_!7477)))
      (+ (- 1) (ite MW_S1_V4 S1_V4_!7488 V4_0)))))
    (let
    (($x63108
      ...
      (not (<= V4_0 E2_!7477))
      (not
      (<= (ite MW_S1_V4 S1_V4_!7482 V4_0)
      (+ 1 (ite MW_S1_V3 S1_V3_!7479 E2_!7477)))) $x62425
      (>= (ite MW_S1_V1 S1_V1_!7484 E1_!7475)
      ...
      (not
      (<= (ite MW_S1_V4 S1_V4_!7503 V4_0)
      (+ 1 (ite MW_S1_V3 S1_V3_!7500 E2_!7491))))
      (not (<= (ite MW_S1_V2 S1_V2_!7501 V2_0) E1_!7505))
      (>= (ite MW_S1_V1 S1_V1_!7506 E1_!7505)
      (+ (- 1) (ite MW_S1_V2 S1_V2_!7508 V2_0))) $x61229)))
    ...
    (($x64341
      ...
      (or $x199
      (= (ite MW_S1_V3 S1_V3_!7500 E2_!7491)
      (+ (- 1) (ite MW_S1_V3 S1_V3_!7494 E2_!7491))))
      (or (not R_S1_V2)
    ...
    (($x62798
      ...
      (or $x199
      (= (ite MW_S1_V3 S1_V3_!7500 E2_!7491)
      (ite MW_S1_V3 S1_V3_!7479 E2_!7477)))
      (or (not R_S1_V2)
    ...
    (($x62522
      ...
      (or $x199 (= (ite MW_S1_V3 S1_V3_!7500 E2_!7491) (+ (- 1) E2_!7477)))
      (or (not R_S1_V2) (= (ite MW_S1_V2 S1_V2_!7501 V2_0) V2_0))
      (or (not R_S1_V5) (= (ite MW_S1_V5 S1_V5_!7502 V5_0) V5_0))
      (or (not R_S1_V4) (= (ite MW_S1_V4 S1_V4_!7503 V4_0) V4_0))
      (or (not R_S1_V6) (= (ite MW_S1_V6 S1_V6_!7504 V6_0) V6_0)))))
    ...
    (($x60079
      ...
      (or $x199
      (= (ite MW_S1_V3 S1_V3_!7494 E2_!7491)
      (+ 1 (ite MW_S1_V3 S1_V3_!7479 E2_!7477))))
      (or (not R_S1_V2)
    ...
    (($x62996
      ...
      (or $x199 (= (ite MW_S1_V3 S1_V3_!7494 E2_!7491) E2_!7477))
      (or (not R_S1_V2) (= (ite MW_S1_V2 S1_V2_!7495 V2_0) V2_0))
      (or (not R_S1_V5) (= (ite MW_S1_V5 S1_V5_!7496 V5_0) V5_0))
      (or (not R_S1_V4) (= (ite MW_S1_V4 S1_V4_!7497 V4_0) V4_0))
      (or (not R_S1_V6) (= (ite MW_S1_V6 S1_V6_!7498 V6_0) V6_0)))))
    (let (($x62800 (not $x62996)))
    (let
    (($x64781
      (and (or $x197 (= E1_!7492 E1_!7505))
      (or $x199 (= E2_!7491 (+ 1 (ite MW_S1_V3 S1_V3_!7500 E2_!7491))))
      (or (not R_S1_V2) (= V2_0 (ite MW_S1_V2 S1_V2_!7501 V2_0)))
      (or (not R_S1_V5) (= V5_0 (ite MW_S1_V5 S1_V5_!7502 V5_0)))
      (or (not R_S1_V4) (= V4_0 (ite MW_S1_V4 S1_V4_!7503 V4_0)))
      (or (not R_S1_V6) (= V6_0 (ite MW_S1_V6 S1_V6_!7504 V6_0))))))
    (let
    (($x62984
      (and (or $x197 (= E1_!7492 (+ 1 (ite MW_S1_V1 S1_V1_!7493 E1_!7492))))
      (or $x199 (= E2_!7491 (ite MW_S1_V3 S1_V3_!7494 E2_!7491)))
      (or (not R_S1_V2) (= V2_0 (ite MW_S1_V2 S1_V2_!7495 V2_0)))
      (or (not R_S1_V5) (= V5_0 (ite MW_S1_V5 S1_V5_!7496 V5_0)))
      (or (not R_S1_V4) (= V4_0 (ite MW_S1_V4 S1_V4_!7497 V4_0)))
      (or (not R_S1_V6) (= V6_0 (ite MW_S1_V6 S1_V6_!7498 V6_0))))))
    (let (($x62904 (not $x62984)))
    (let
    (($x62345
      (and (or $x197 (= E1_!7492 (ite MW_S1_V1 S1_V1_!7478 E1_!7475)))
      (or $x199 (= E2_!7491 (+ 1 (ite MW_S1_V3 S1_V3_!7479 E2_!7477))))
      (or (not R_S1_V2) (= V2_0 (ite MW_S1_V2 S1_V2_!7480 V2_0)))
      (or (not R_S1_V5) (= V5_0 (ite MW_S1_V5 S1_V5_!7481 V5_0)))
      (or (not R_S1_V4) (= V4_0 (ite MW_S1_V4 S1_V4_!7482 V4_0)))
      (or (not R_S1_V6) (= V6_0 (ite MW_S1_V6 S1_V6_!7483 V6_0))))))
    (let (($x62691 (not $x62345)))
    (let
    (($x62812
      (or
      (not
      (and (or $x197 (= E1_!7492 E1_!7475)) (or $x199 (= E2_!7491 E2_!7477))))
      (= S1_V6_!7498 S1_V6_!7483))))
    (let
    (($x62504
      (and (or $x197 (= E1_!7475 (ite MW_S1_V1 S1_V1_!7478 E1_!7475)))
      (or $x199 (= E2_!7477 (+ 1 (ite MW_S1_V3 S1_V3_!7479 E2_!7477))))
      (or (not R_S1_V2) (= V2_0 (ite MW_S1_V2 S1_V2_!7480 V2_0)))
      (or (not R_S1_V5) (= V5_0 (ite MW_S1_V5 S1_V5_!7481 V5_0)))
      (or (not R_S1_V4) (= V4_0 (ite MW_S1_V4 S1_V4_!7482 V4_0)))
      (or (not R_S1_V6) (= V6_0 (ite MW_S1_V6 S1_V6_!7483 V6_0))))))
    ...
    (($x64886
      ...
      (or $x199 (= (ite MW_S1_V3 S1_V3_!7500 E2_!7491) (+ (- 1) E2_!7491)))
      (or (not R_S1_V2) (= (ite MW_S1_V2 S1_V2_!7501 V2_0) V2_0))
      (or (not R_S1_V5) (= (ite MW_S1_V5 S1_V5_!7502 V5_0) V5_0))
      (or (not R_S1_V4) (= (ite MW_S1_V4 S1_V4_!7503 V4_0) V4_0))
      (or (not R_S1_V6) (= (ite MW_S1_V6 S1_V6_!7504 V6_0) V6_0)))))
    ...
    (($x59882
      ...
      (or $x199 (= (ite MW_S1_V3 S1_V3_!7494 E2_!7491) E2_!7491))
      (or (not R_S1_V2) (= (ite MW_S1_V2 S1_V2_!7495 V2_0) V2_0))
      (or (not R_S1_V5) (= (ite MW_S1_V5 S1_V5_!7496 V5_0) V5_0))
      (or (not R_S1_V4) (= (ite MW_S1_V4 S1_V4_!7497 V4_0) V4_0))
      (or (not R_S1_V6) (= (ite MW_S1_V6 S1_V6_!7498 V6_0) V6_0)))))
    ...
    (($x60261
      ...
      (or $x199 (= E2_!7477 (+ 1 (ite MW_S1_V3 S1_V3_!7500 E2_!7491))))
      (or (not R_S1_V2) (= V2_0 (ite MW_S1_V2 S1_V2_!7501 V2_0)))
      (or (not R_S1_V5) (= V5_0 (ite MW_S1_V5 S1_V5_!7502 V5_0)))
      (or (not R_S1_V4) (= V4_0 (ite MW_S1_V4 S1_V4_!7503 V4_0)))
      (or (not R_S1_V6) (= V6_0 (ite MW_S1_V6 S1_V6_!7504 V6_0))))))
    ...
    (($x62947
      (not
      (and (or $x197 (= E1_!7475 E1_!7492)) (or $x199 (= E2_!7477 E2_!7491))))))
    (let
    (($x59943
      (and (or $x197 (= E1_!7475 (+ 1 (ite MW_S1_V1 S1_V1_!7493 E1_!7492))))
      (or $x199 (= E2_!7477 (ite MW_S1_V3 S1_V3_!7494 E2_!7491)))
      (or (not R_S1_V2) (= V2_0 (ite MW_S1_V2 S1_V2_!7495 V2_0)))
      (or (not R_S1_V5) (= V5_0 (ite MW_S1_V5 S1_V5_!7496 V5_0)))
      (or (not R_S1_V4) (= V4_0 (ite MW_S1_V4 S1_V4_!7497 V4_0)))
      (or (not R_S1_V6) (= V6_0 (ite MW_S1_V6 S1_V6_!7498 V6_0))))))
    ...
    (($x62297
      ...
      (or $x199 (= (ite MW_S1_V3 S1_V3_!7479 E2_!7477) (+ (- 1) E2_!7491)))
      (or (not R_S1_V2) (= (ite MW_S1_V2 S1_V2_!7480 V2_0) V2_0))
      (or (not R_S1_V5) (= (ite MW_S1_V5 S1_V5_!7481 V5_0) V5_0))
      (or (not R_S1_V4) (= (ite MW_S1_V4 S1_V4_!7482 V4_0) V4_0))
      (or (not R_S1_V6) (= (ite MW_S1_V6 S1_V6_!7483 V6_0) V6_0)))))
    (let (($x62325 (not $x62297)))
    (let
    (($x61096
      (and (or $x197 (= (ite MW_S1_V1 S1_V1_!7478 E1_!7475) E1_!7475))
      (or $x199 (= (ite MW_S1_V3 S1_V3_!7479 E2_!7477) (+ (- 1) E2_!7477)))
      (or (not R_S1_V2) (= (ite MW_S1_V2 S1_V2_!7480 V2_0) V2_0))
      (or (not R_S1_V5) (= (ite MW_S1_V5 S1_V5_!7481 V5_0) V5_0))
      (or (not R_S1_V4) (= (ite MW_S1_V4 S1_V4_!7482 V4_0) V4_0))
      (or (not R_S1_V6) (= (ite MW_S1_V6 S1_V6_!7483 V6_0) V6_0)))))
    ...
    (($x64853
      ...
      (or (not $x64312) (= S1_V3_!7485 S1_V3_!7507)) $x63868
      ...
      (or $x65118 (= E1_!7475 E1_!7505)) 
      (= E1_!7490 E1_!7475) 
      (= E1_!7490 E1_!7492) 
      (or $x65118 (= E1_!7490 E1_!7505)) 
      (= E1_!7492 E1_!7475) 
      (or $x65118 (= E1_!7492 E1_!7505))
      ...
      (= E2_!7476 E2_!7477)
      (or (not (or (not R_E2_V1) (= E1_!7490 E1_!7475)))
      (= E2_!7491 E2_!7476))
      (or (not (or (not R_E2_V1) (= E1_!7490 E1_!7475)))
      (= E2_!7491 E2_!7477)) 
      ...
      (or $x61447 (= S1_V6_!7483 S1_V6_!7489)) $x62812
