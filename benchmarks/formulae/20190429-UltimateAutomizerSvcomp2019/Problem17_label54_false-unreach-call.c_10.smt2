...
(assert (and (or (and (<= c_~a28~0 300) (< 134 c_~a28~0)) (< 300 c_~a28~0)) (= c_~a28~0_primed (let ((.cse0 (let ((.cse2 (let ((.cse4 (div c_~a28~0 5))) (ite (and (< c_~a28~0 0) (not (= 0 (mod c_~a28~0 5)))) (+ .cse4 1) .cse4)))) (let ((.cse3 (div .cse2 5))) (ite (and (< .cse2 0) (not (= (mod .cse2 5) 0))) (+ .cse3 1) .cse3))))) (let ((.cse1 (div .cse0 (- 5)))) (ite (and (not (= (mod .cse0 (- 5)) 0)) (< .cse0 0)) (+ .cse1 (- 1)) .cse1)))) (= c_~a24~0_primed 1) (< 0 (+ c_~a14~0 84)) (= c_~a14~0_primed (+ (let ((.cse5 (* 9 c_~a14~0))) (let ((.cse6 (div .cse5 10))) (ite (and (< .cse5 0) (not (= (mod .cse5 10) 0))) (+ .cse6 1) .cse6))) (- 575682))) (<= c_~a21~0 127) (<= (+ c_~a26~0 68) 0) (= c_calculate_output_~input 6) (= |c_calculate_output_#res_primed| (- 1)) (= 2 c_~a24~0)))
