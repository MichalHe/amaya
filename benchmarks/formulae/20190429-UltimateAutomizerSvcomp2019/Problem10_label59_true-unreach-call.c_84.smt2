...
(assert (not (let ((.cse0 (<= 3 c_~a10~0))) (and (exists ((v_prenex_243 Int) (v_~a1~0_482 Int)) (and (<= 23 v_~a1~0_482) (<= (mod v_prenex_243 299993) (+ c_~a1~0 300007)) (<= 0 v_prenex_243) (<= (+ (* 5 v_~a1~0_482) 517989) v_prenex_243))) (or (and .cse0 (exists ((v_~a1~0_483 Int)) (let ((.cse1 (mod v_~a1~0_483 299993))) (and (<= |c_old(~a1~0)| v_~a1~0_483) (<= .cse1 (+ c_~a1~0 600000)) (not (= .cse1 0)) (< v_~a1~0_483 0))))) (and .cse0 (exists ((v_~a1~0_483 Int)) (and (<= |c_old(~a1~0)| v_~a1~0_483) (<= 0 v_~a1~0_483) (<= (mod v_~a1~0_483 299993) (+ c_~a1~0 300007)))))) .cse0))))
(check-sat)
(exit)
