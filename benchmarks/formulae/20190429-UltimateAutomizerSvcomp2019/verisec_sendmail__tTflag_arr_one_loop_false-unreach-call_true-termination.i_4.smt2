...
(assert (let ((.cse4 (mod main_~c~0 256))) (or (forall ((v_prenex_2 Int) (v_subst_1 Int)) (let ((.cse2 (mod v_subst_1 256))) (let ((.cse3 (mod (+ .cse2 (* 10 (mod (+ (mod main_~c~0 256) (* 10 main_~i~0) 4294967248) 4294967296)) 4294967248) 4294967296)) (.cse1 (mod v_prenex_2 256))) (let ((.cse0 (mod (+ (* 10 .cse3) .cse1 4294967248) 4294967296))) (or (<= .cse0 2147483647) (< 57 .cse1) (< 57 .cse2) (< .cse2 48) (< 2147483647 .cse3) (< 4294967295 .cse0) (< .cse1 48)))))) (< .cse4 48) (<= (mod (+ .cse4 (* 10 main_~i~0) 4294967248) 4294967296) 2147483647) (< 57 .cse4))))
(assert (let ((.cse0 (mod main_~c~0 256))) (or (< .cse0 48) (<= (mod (+ .cse0 (* 10 main_~i~0) 4294967248) 4294967296) 2147483647) (< 57 .cse0) (forall ((v_prenex_4 Int) (v_prenex_3 Int)) (let ((.cse1 (mod v_prenex_4 256))) (let ((.cse3 (mod (+ (* 10 (mod (+ (mod main_~c~0 256) (* 10 main_~i~0) 4294967248) 4294967296)) .cse1 4294967248) 4294967296)) (.cse4 (mod v_prenex_3 256))) (let ((.cse2 (mod (+ (* 10 .cse3) .cse4 4294967248) 4294967296))) (or (< .cse1 48) (< 4294967295 .cse2) (<= .cse2 2147483647) (<= .cse3 2147483647) (< 57 .cse4) (< .cse4 48) (< 57 .cse1)))))))))
(assert (not (forall ((v_prenex_6 Int) (v_prenex_5 Int)) (let ((.cse3 (mod v_prenex_5 256))) (let ((.cse0 (mod (+ (* 10 (mod (+ (mod main_~c~0 256) (* 10 main_~i~0) 4294967248) 4294967296)) .cse3 4294967248) 4294967296)) (.cse1 (mod v_prenex_6 256))) (let ((.cse2 (mod (+ (* 10 .cse0) .cse1 4294967248) 4294967296))) (or (<= .cse0 2147483647) (< 57 .cse1) (< 4294967295 .cse2) (<= .cse2 2147483647) (< .cse3 48) (< .cse1 48) (< 57 .cse3))))))))
(assert (not (< (mod main_~c~0 256) 48)))
(assert (not (< 57 (mod main_~c~0 256))))
(assert (< 2147483647 (mod (+ (mod main_~c~0 256) (* 10 main_~i~0) 4294967248) 4294967296)))
(check-sat)
(exit)
