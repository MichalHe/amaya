...
(assert (not (forall ((|main_#t~nondet0| Int) (|main_#t~nondet1| Int) (|main_#t~nondet2| Int)) (not (= (mod (+ (* 8 |main_#t~nondet0|) (* 4 c_main_~x~0_primed) (* 2 c_main_~y~0_primed) c_main_~z~0_primed (* 8 |main_#t~nondet1|) (* 8 |main_#t~nondet2|)) 4294967296) 4)))))
(check-sat)
(exit)
