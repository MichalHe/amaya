...
(assert (not (and (<= |old(~a10~0)| 3) (exists ((v_prenex_250 Int)) (and (<= 0 v_prenex_250) (<= |old(~a1~0)| v_prenex_250) (<= (+ (div v_prenex_250 5) 449582) ~a1~0) (<= (+ v_prenex_250 13) 0))))))
...
(assert (exists ((v_prenex_249 Int)) (and (< v_prenex_249 0) (not (= 0 (mod v_prenex_249 5))) (<= |old(~a1~0)| v_prenex_249) (<= (+ (div v_prenex_249 5) 449583) ~a1~0) (<= (+ v_prenex_249 13) 0))))
(assert (<= |old(~a10~0)| 3))
(check-sat)
(exit)
