...
(assert (not (exists ((v_prenex_81 Int)) (let ((.cse0 (* 4 (div v_prenex_81 5)))) (and (<= 0 (+ .cse0 4)) (<= 0 v_prenex_81) (<= 0 .cse0) (<= ~a29~0 (+ (mod .cse0 299978) 300021)))))))
(assert (not (exists ((v_prenex_81 Int)) (let ((.cse1 (* 4 (div v_prenex_81 5)))) (let ((.cse0 (+ .cse1 4))) (and (<= 0 .cse0) (<= 0 .cse1) (< v_prenex_81 0) (not (= 0 (mod v_prenex_81 5))) (<= ~a29~0 (+ (mod .cse0 299978) 300021))))))))
(assert (not (exists ((v_prenex_81 Int)) (let ((.cse1 (* 4 (div v_prenex_81 5)))) (let ((.cse0 (mod .cse1 299978))) (and (<= ~a29~0 (+ .cse0 300021)) (= 0 .cse0) (= (mod (+ .cse1 4) 299978) 0) (= 0 (mod v_prenex_81 5))))))))
(check-sat)
(exit)
