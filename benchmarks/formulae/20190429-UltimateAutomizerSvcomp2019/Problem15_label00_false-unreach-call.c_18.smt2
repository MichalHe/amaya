...
(assert (exists ((v_~a29~0_1040 Int)) (let ((.cse0 (div v_~a29~0_1040 5))) (and (<= 0 v_~a29~0_1040) (< .cse0 403019) (<= v_~a29~0_1040 |old(~a29~0)|) (<= ~a29~0 (+ (div (+ .cse0 (- 403019)) 5) 1)) (not (= 0 (mod (+ .cse0 1) 5)))))))
(check-sat)
(exit)
