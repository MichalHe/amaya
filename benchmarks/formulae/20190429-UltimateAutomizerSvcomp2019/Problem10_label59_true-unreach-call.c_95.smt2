...
(assert (and (= 6 c_calculate_output_~input) (= 14 c_~a4~0) (= c_~a1~0_primed (+ (let ((.cse0 (let ((.cse2 (mod c_~a1~0 25))) (ite (and (< c_~a1~0 0) (not (= .cse2 0))) (+ .cse2 (- 25)) .cse2)))) (let ((.cse1 (div (+ .cse0 (- 42592)) 5))) (ite (and (not (= (mod (+ .cse0 3) 5) 0)) (< .cse0 42592)) (+ .cse1 1) .cse1))) 8517)) (or (and (< 218 c_~a1~0) (= 0 c_~a10~0)) (and (<= (+ c_~a1~0 13) 0) (= 1 c_~a10~0))) (= |c_calculate_output_#res_primed| 26) (= 0 c_~a12~0) (= 9 c_~a19~0) (= c_~a10~0_primed 3)))
