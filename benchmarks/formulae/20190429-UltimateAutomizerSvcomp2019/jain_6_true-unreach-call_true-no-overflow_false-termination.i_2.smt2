...
(assert (not (and (exists ((|v_main_#t~nondet1_5| Int)) (= (* 4 |v_main_#t~nondet1_5|) c_main_~y~0)) (exists ((|v_main_#t~nondet0_5| Int)) (= (* 2 |v_main_#t~nondet0_5|) c_main_~x~0)) (exists ((|v_main_#t~nondet2_5| Int)) (= (* 8 |v_main_#t~nondet2_5|) c_main_~z~0)))))
(check-sat)
(exit)
