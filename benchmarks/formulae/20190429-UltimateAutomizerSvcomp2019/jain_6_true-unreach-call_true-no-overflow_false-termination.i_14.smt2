...
(assert (not (and (exists ((|v_main_#t~nondet2_5| Int) (|v_main_#t~nondet2_6| Int)) (= c_main_~z~0_primed (+ (* 8 |v_main_#t~nondet2_5|) (* 8 |v_main_#t~nondet2_6|)))) (exists ((|v_main_#t~nondet1_6| Int) (|v_main_#t~nondet1_5| Int)) (= (+ (* 4 |v_main_#t~nondet1_6|) (* 4 |v_main_#t~nondet1_5|)) c_main_~y~0_primed)) (exists ((|v_main_#t~nondet0_5| Int) (|v_main_#t~nondet0_6| Int)) (= (+ (* 2 |v_main_#t~nondet0_5|) (* 2 |v_main_#t~nondet0_6|)) c_main_~x~0_primed)))))
(check-sat)
(exit)
