...
(assert (or (not (= c_calculate_output_~input 5)) (not (<= c_~a26~0 124)) (not (= 2 c_~a24~0)) (not (< 0 (+ c_~a26~0 68))) (not (<= c_~a21~0 127)) (let ((.cse2 (+ c_~a14~0 114))) (let ((.cse0 (not (< 0 (+ c_~a14~0 182)))) (.cse1 (not (<= .cse2 0)))) (and (or (not (< 300 c_~a28~0)) .cse0 .cse1) (or (not (< 0 .cse2)) (not (<= (+ c_~a14~0 84) 0)) (not (<= c_~a28~0 37))) (or (not (< 134 c_~a28~0)) .cse0 (not (<= c_~a28~0 300)) .cse1))))))
