...
(assert (not (< 2147483647 (mod (+ (mod main_~c~0 256) (* 10 main_~i~0) 4294967248) 4294967296))))
(assert (not (< 57 (mod main_~c~0 256))))
(assert (not (< (mod main_~c~0 256) 48)))
(assert (forall ((v_prenex_7 Int) (v_prenex_8 Int)) (let ((.cse3 (mod v_prenex_8 256))) (let ((.cse2 (mod (+ .cse3 (* 10 (mod (+ (mod main_~c~0 256) (* 10 main_~i~0) 4294967248) 4294967296)) 4294967248) 4294967296)) (.cse1 (mod v_prenex_7 256))) (let ((.cse0 (mod (+ (* 10 .cse2) .cse1 4294967248) 4294967296))) (or (< 4294967295 .cse0) (< 57 .cse1) (< 2147483647 .cse2) (< 57 .cse3) (<= .cse0 2147483647) (< .cse3 48) (< .cse1 48)))))))
(check-sat)
(exit)
