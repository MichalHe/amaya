...
(assert (or (not (< 0 (+ c_~a14~0 84))) (not (<= (+ c_~a26~0 68) 0)) (not (<= c_~a21~0 127)) (not (= c_calculate_output_~input 6)) (not (= 2 c_~a24~0)) (and (or (not (< 134 c_~a28~0)) (not (<= c_~a28~0 300))) (not (< 300 c_~a28~0)))))
