...
(assert (or (let ((.cse1 (+ c_~a14~0 84))) (let ((.cse0 (not (< 0 .cse1)))) (and (or (not (< 37 c_~a28~0)) (not (<= c_~a28~0 134)) .cse0) (or (not (< 300 c_~a28~0)) (not (< 0 (+ c_~a14~0 114))) (not (<= .cse1 0))) (or (not (<= c_~a28~0 37)) .cse0)))) (not (= 3 c_~a24~0)) (not (= c_calculate_output_~input 2)) (not (< 0 (+ c_~a26~0 68))) (not (<= c_~a21~0 127)) (not (<= c_~a26~0 124))))
