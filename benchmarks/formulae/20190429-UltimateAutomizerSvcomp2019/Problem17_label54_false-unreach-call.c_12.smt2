...
(assert (or (not (< 124 c_~a26~0)) (and (not (< 300 c_~a28~0)) (or (not (<= c_~a28~0 134)) (not (< 37 c_~a28~0))) (or (not (< 134 c_~a28~0)) (not (<= c_~a28~0 300)))) (not (<= c_~a26~0 217)) (not (<= (+ c_~a14~0 114) 0)) (not (= 2 c_~a24~0)) (not (< 0 (+ c_~a14~0 182))) (not (= c_calculate_output_~input 1)) (not (<= c_~a21~0 127))))
