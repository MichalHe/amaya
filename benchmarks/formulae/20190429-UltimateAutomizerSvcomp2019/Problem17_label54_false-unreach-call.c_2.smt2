...
(assert (or (not (= 2 c_~a24~0)) (let ((.cse0 (+ c_~a14~0 182))) (and (or (not (< 300 c_~a28~0)) (not (<= .cse0 0))) (or (not (<= (+ c_~a14~0 114) 0)) (not (< 0 .cse0)) (not (<= c_~a28~0 37))))) (not (= c_calculate_output_~input 5)) (not (<= c_~a21~0 127)) (not (< 217 c_~a26~0))))
