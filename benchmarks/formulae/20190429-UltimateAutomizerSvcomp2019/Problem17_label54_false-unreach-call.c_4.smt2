...
(assert (or (and (not (< 300 c_~a28~0)) (or (not (< 134 c_~a28~0)) (not (<= c_~a28~0 300))) (or (not (<= c_~a28~0 134)) (not (< 37 c_~a28~0)))) (not (<= c_~a21~0 127)) (not (= 1 c_~a24~0)) (not (= c_calculate_output_~input 6)) (not (< 0 (+ c_~a14~0 84))) (not (< 217 c_~a26~0))))
