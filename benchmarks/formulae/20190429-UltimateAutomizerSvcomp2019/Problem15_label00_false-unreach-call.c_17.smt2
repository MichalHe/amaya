...
(assert (not (exists ((v_~a29~0_1040 Int)) (let ((.cse0 (div v_~a29~0_1040 5))) (and (< .cse0 403019) (<= v_~a29~0_1040 |old(~a29~0)|) (= (mod v_~a29~0_1040 5) 0) (<= ~a29~0 (+ (div (+ .cse0 (- 403019)) 5) 1)) (not (= 0 (mod (+ .cse0 1) 5))))))))
...
(assert (exists ((v_~a29~0_1040 Int)) (let ((.cse0 (div v_~a29~0_1040 5))) (and (<= ~a29~0 (+ (div (+ .cse0 (- 403018)) 5) 1)) (< v_~a29~0_1040 0) (<= v_~a29~0_1040 |old(~a29~0)|) (< .cse0 403018) (not (= (mod (+ .cse0 2) 5) 0)) (not (= (mod v_~a29~0_1040 5) 0))))))
(check-sat)
(exit)
